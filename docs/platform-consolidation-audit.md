...
- SQL: `0001`–`0009` (`0008` = outbox status/lease + writeback; `0009` = ObjectSet GIN + link indexes)
...
| P19 | SQL ObjectSet planner | DONE — `compile-sql.ts` + `resolver-pg`; memory ≡ PG (`gate:objectset-parity`); GIN/link indexes in `0009` |
